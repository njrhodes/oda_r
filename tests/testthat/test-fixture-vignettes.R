...
# Coverage: rule type/cut, confusion matrix (raw integer, actual × predicted), ESS.
...
# Gold rule: V1∈{1,2}→V2=1 (Community);  V1∈{3,4}→V2=0 (Individual)
...
# Confusion 4×4 (actual × predicted): [[98,16,5,3],[13,50,2,8],[6,4,23,12],[7,19,14,45]]
# ESS: 50.96%
# =============================================================================
