...
- **LOO jackknife:** Leave-one-out ESS and Mean PAC are shown. Each fold
  holds out one observation, refits on the remaining n-1 observations
  (non-directional, equal priors), and classifies the held-out case. LOO ESS
  equal to or near training ESS indicates the model is stable  -  no single
  observation drives the result.
